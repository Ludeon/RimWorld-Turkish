...
* [ ] Strings
 * [ ] NameBank
    - [x] Adjectives_Angsty.txt
    - [x] Adjectives_Badass.txt
    - [x] CapitalLetters.txt
    - [ ] ColonyNames.txt
    - [x] Colors.txt
    - [x] ColorsBadass.txt 
    ...
    - [ ] Nouns_Animals.txt
    - [x] Nouns_Apparel.txt
    - [x] Nouns_Artworks.txt
    - [ ] Nouns_BadassAnimals.txt
    - [ ] Nouns_BadassPersons.txt
    - [x] Nouns_BusinessTypes.txt
    - [ ] Nouns_Communities.txt
    - [x] Nouns_Concepts_Angsty.txt
    - [x] Nouns_Concepts_Badass.txt
